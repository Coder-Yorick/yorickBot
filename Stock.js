...
function Stock() {
    ...
    this.QueryStockName = function (stockID, callback) {
    ...
    this.GetStockInfo = function (stockID, callback) {
        request(STOCK_WEBSITE + stockID, (err, res, body) => {
            try {
                const $ = cheerio.load(body, { decodeEntities: false });
    ...
    this.GetDividendYieldBoard = function (callback) {
